...
public class LargeImageView extends View {
    ...
    //移动步长
    private float MOVE_SCALE = 0.35f;
    //大图移动量
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            if (null != mDecoder) {
                ...
                if (mPictureDegree == 180) {
                    mBitmap = BitmapUtils.rotateBitmapByDegree(mBitmap, mPictureDegree);
                }
    ...
    public void moveEvent(EKeyEvent keyEvent) {
        ...
        switch (keyEvent) {
            case UP:
                mRectLarge.offset(0, mPictureDegree == 180 ? (moveY + mMoveY) : (moveY - mMoveY));
            ...
            case LEFT:
                ...
                mRectLarge.offset(mPictureDegree == 180 ? (moveX + mMoveX) : (moveX - mMoveX), 0);
